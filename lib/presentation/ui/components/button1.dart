...
class MySimpleBotton extends StatelessWidget {
  ...
  MySimpleBotton({required this.name,this.textColor=Colors.white,this.borderRadius=7,required this.width,required this.height,this.onclick,this.color=AppColors.secondaryColor,this.fontSize=14});
