...
class AboutUsHeader extends StatelessWidget {
  ...
  AboutUsHeader({required this.width,required this.size});
        ...
        child: Container(
          ...
          child: Column(
            children: [
              ...
              Text(
                'EBP is a digital platform that provides various risk-free earning opportunities for investors\n'
                    'and networkers o that they can boost their earning levels with mental satisfaction.',
