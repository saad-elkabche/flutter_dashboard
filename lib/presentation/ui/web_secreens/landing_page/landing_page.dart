    ...
    return Scaffold(
      body:ListView(
        children: [
          ...
          FirstSection(size: size,width: width,getStarted: (){GoRouter.of(context).go(Routes.signup);},learnMore: (){},),
          const SizedBox(height: 26),
          SecondSection(size: size),
          const SizedBox(height: 26,),
          PlansSection(size: size,width: width,),
          const SizedBox(height: 26,),
          SectionThree(size: size),
          const SizedBox(height: 26),
          ReferralProgram(size: size,width: width,),
          const SizedBox(height: 26,),
          SafetySecurity(size: size,width: width,),
          const SizedBox(height: 26,),
